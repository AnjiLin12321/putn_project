...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /putn_ws/src/putn/src/putn/putn_waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /putn_ws/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /putn_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/putn_ws/src/putn/src/putn/putn_waypoint_generator/${idir}'.  ${_report}")
    endif()
